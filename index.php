...
<head>
    ...
    <style>
        ...
        .hero-section {
            background: linear-gradient(rgba(44,24,16,0.5), rgba(111,78,55,0.7)), url('/CafeConnect/assets/img/landing_homepage.png') center/cover;
...
<body class="d-flex flex-column h-100">
    ...
    <div class="hero-section text-center">
        <div class="container">
            <img src="/CafeConnect/assets/img/landing_logo.png" alt="CafeConnect Logo" class="hero-logo mb-4" style="max-height: 180px;">
    ...
    <div class="container py-5 my-5">
        <div class="row align-items-center">
            ...
            <div class="col-md-6 cc-animate-fade-in">
                <img src="/CafeConnect/assets/img/Coffee Shop banner.jpg" class="img-fluid cc-rounded-lg cc-shadow-lg" alt="Cafe">
            </div>
        </div>
    </div>
    ...
    <div class="cc-bg-latte py-5">
        <div class="container py-4">
            ...
            <p class="text-center text-muted mb-5">Most loved items by our community</p>
                ...
                <div class="col">
                    <div class="cc-card position-relative">
                        ...
                        <div class="p-3">
                            ...
                            <p class="fw-bold cc-text-coffee mb-0"><?= $item['f_price'] ?> Rs.</p>
                        </div>
                    </div>
                </div>
                <?php }} ?>
