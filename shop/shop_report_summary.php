...
<body class="d-flex flex-column min-vh-100">
    ...
    <div class="container px-5 py-4" id="shop-body">
        <div class="mt-4">
            ...
            <p class="fw-light">Generated on <?php echo date("F j, Y H:i")?>. 
                        ...
                        <div class="card-body">
                            <h5 class="card-title">
                                <?php
                                                    ...
                                                    $result = $res ? $res->fetch_array() : null;
                                                    $grandtotal = ($result && !is_null($result["rev"])) ? $result["rev"] : 0;
                        ...
                        <div class="card-body">
                            <h5 class="card-title">
                                <?php
                                    ...
                                    $res = $mysqli->query($query);
                                    $result = $res ? $res->fetch_array() : null;
                                    $num_order = ($result && !is_null($result["cnt"])) ? (int)$result["cnt"] : 0;
                        ...
                        <div class="card-body">
                            <h5 class="card-title">
                                <?php
                                    ...
                                    $res = $mysqli->query($query);
                                    $result = $res ? $res->fetch_array() : null;
                                    if(!$result || is_null($result["cnt"])) { echo "0 Customers"; } else { echo (int)$result["cnt"]." Customers"; }
                                ?>
                            </h5>
