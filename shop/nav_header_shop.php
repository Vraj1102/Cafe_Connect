    ...
    <div class="container-fluid mx-4">
        ...
        <div class="navbar-collapse collapse" id="navbarCollapse">
            <ul class="navbar-nav me-auto mb-2 mb-md-0">
                <li class="nav-item">
                    <a class="nav-link px-3 text-white fw-semibold" href="shop_home.php"><i class="bi bi-house-door"></i> Dashboard</a>
                </li>
                <li class="nav-item">
                    <a href="shop_order_list.php" class="nav-link px-3 text-white fw-semibold"><i class="bi bi-receipt"></i> Orders</a>
                </li>
                <li class="nav-item">
            ...
            <div class="d-flex">
                ...
                <ul class="navbar-nav me-auto mb-2 mb-md-0">
                    <li class="nav-item">
                        <a href="shop_profile.php" class="nav-link px-2 text-white">
