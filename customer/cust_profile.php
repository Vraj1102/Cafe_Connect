...
<head>
    ...
    <title>My Profile | CafeConnect</title>
</head>
...
<?php include('../includes/nav_header.php')?>
    ...
    <div class="container px-5 py-4" id="cart-body">
        <div class="row my-4 pb-2 border-bottom">
            ...
            <h2 class="pt-3 cc-text-coffee"><i class="bi bi-person-circle" style="font-size: 2.5rem;"></i> My Profile</h2>
        </div>

        <a class="btn-cc-secondary btn-sm me-2" href="cust_update_pwd.php">
            <i class="bi bi-key"></i>
            Change password
        </a>
        <a class="btn-cc-primary btn-sm mt-2 mt-md-0" href="cust_update_profile.php">
        ...
        <?php
            // Select customer record from database (defensive)
                ...
                if ($result && $result->num_rows > 0) {
                    ...
                    // Provide safe defaults to avoid calling fetch on bool
                    $row = array(
                        'c_username' => '',
